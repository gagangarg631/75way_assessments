        ...
        >
            ...
            <StyledBox sx={{}}>
                ...
                <Typography variant="p" sx={{ lineHeight: 2 }}>
                    ...
                    practical goals in a reproducible way.[1] The word
                    technology can also mean the products resulting from such
                    efforts,[2]: 117 [3] including both tangible tools such as
                    utensils or machines
                </Typography>

                <StyledButton
                    sx={{ height: "50px", marginTop: 5 }}
                    click={handleAccept}
                    value="I accept"
                />
            </StyledBox>
